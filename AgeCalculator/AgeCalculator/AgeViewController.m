...
- (IBAction)birthdateSelected:(UIDatePicker *)sender
{
    ...
    int age = [self findAgeFromBirthdate:(NSDate *)birthdate];
    ...
    NSDate *nextBirthday = [self findNextBirthdayUsingBirthdate:(NSDate *)birthdate];
...
- (NSDate *)findNextBirthdayUsingBirthdate:(NSDate *)birthdate
{
    ...
    [birthdateComponents setYear:NSCalendarUnitYear];
